# alx-Maze-Project
This is the Research & Project approval (Part 1) project in the ALX Software Engineering program under project portfolio.

# **Maze project**

## Main Context

The aim of this project is to create a game in 3D using raycasting !
